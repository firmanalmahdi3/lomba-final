...
@section('title', 'Register — Festival Film Pendek Blitar')
    ...
    <div class="max-w-md w-full space-y-8 bg-white p-10 rounded-2xl shadow-xl">
        <div>
            ...
            <p class="mt-2 text-center text-sm text-gray-600">
                Sudah punya akun?
                <a href="{{ route('login') }}" class="font-medium text-[#ed8036] hover:text-orange-500">
                    Login di sini
                </a>
            </p>
        </div>
        <form class="mt-8 space-y-6" action="{{ route('register') }}" method="POST">
            ...
            <div class="rounded-md shadow-sm space-y-4">
                <div>
                    ...
                    <input id="name" name="name" type="text" required class="appearance-none rounded-xl relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-[#ed8036] focus:border-[#ed8036] sm:text-sm mt-1" placeholder="Nama Lengkap" value="{{ old('name') }}">
                    @error('name')
                ...
                <div>
                    ...
                    <input id="password_confirmation" name="password_confirmation" type="password" required class="appearance-none rounded-xl relative block w-full px-3 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-[#ed8036] focus:border-[#ed8036] sm:text-sm mt-1" placeholder="Konfirmasi Password">
                </div>
            </div>
